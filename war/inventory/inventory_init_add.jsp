...
<body class="body1">
        <form name="InvIniQtyForm" method='post' action="inventory/inventory!addInventory" target="_self" id="InvIniQtyForm">
            <div align="center">
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td width="522" class="p1" height="2" nowrap='nowrap'>
                            ...
                            &nbsp;
                            <b>分销商库存管理&gt;&gt;分销商库存数量初始化&gt;&gt;添加</b> <span style='color: red'> <s:iterator value="#action.actionMessages" var='msg'> <s:property value='#msg' /> </s:iterator> </span>
                        </td>
                    </tr>
                </table>
                ...
                <table width="95%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
						...
						<td width="78%">
							<input type="text" class="text1" id="clientNo" value='<s:property value="#action.it.distrib.clientno"/>'
                    ...
                    <tr>
                        ...
                        <td>
                            <input  type="text" class="text1" id="materialNo" value='<s:property value="#action.it.material.no"/>'
                                size="32" maxlength="32" readonly="readonly">
                    ...
                    <tr>
                        ...
                        <td>
                            <input  type="text" class="text1" id="materialName" value='<s:property value="#action.it.material.name"/>'
                                size="32" maxlength="32" readonly="readonly">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input  type="text" class="text1" id="materialGuige" size="32" value='<s:property value="#action.it.material.guige"/>'
                    ...
                    <tr>
                        ...
                        <td>
                            <input   type="text" class="text1" id="materialXinghao" value='<s:property value="#action.it.material.xinghao"/>'
                                size="32" maxlength="32" readonly="readonly">
                        </td>
                    </tr>
                        ...
                        <td>
                            <input   type="text" class="text1" id="materialType" size="32" value='<s:property value="#action.it.material.materialType.name"/>'
                                maxlength="32" readonly="readonly">
                        </td>
                    </tr>        <tr>
                        <td height="26">
                        ...
                        <td>
                            <input type="text" class="text1" id="materialUnit" size="32"   value='<s:property value="#action.it.material.materialItemUnit.name"/>'
                                maxlength="32" readonly="readonly">
                        </td>
                    </tr>
                    <tr>
