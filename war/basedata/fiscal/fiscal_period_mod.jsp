...
<html>
	...
	<body class="body1">
		<form name="fiscalYearPeriodForm" target="_self" method='post'
			action='basedata/fiscalPeriod!modFiscalPeriod'
			...
			<div align="center">
				...
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td>
							<label>
								<input type="text" onClick= WdatePicker(); name="fp.startdate"
