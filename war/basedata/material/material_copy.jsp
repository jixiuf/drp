            ...
            <div align="center">
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td width="522" class="p1" height="25" nowrap="nowrap" >
                            ...
                            &nbsp;
                            <b>基础数据管理&gt;&gt;物料维护&gt;&gt;复制修改</b> <span style='color: red'> <s:iterator value="#action.actionMessages" var='msg'> <s:property value='#msg' /> </s:iterator> </span>
                        </td>
                    </tr>
                </table>   
                ...
                <table width="95%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="78%">
                            <input name="m.no" type="text" class="text1" id="itemNo" value='<s:property value="#action.m.no"/>' size="32" maxlength="32"><span style='color:red'>必须修改</span>
                        </td>
                    </tr>
                    <tr>
                        <td height="26">
                        ...
                        <td>
							<select name="m.materialItemUnit.id" class="select1" id="category">
								<s:iterator value="#request.materialItemUnits" var='materialItemUnit'>
									<s:if
										test='%{#action.m.materialItemUnit.id == #materialItemUnit.id}'>
                ...
                </table>      <input type='hidden' name='m.pictFilename' value="<s:property value='#action.m.pictFilename'/>">
                ...
                <input type='hidden' name='m.id' value="<s:property value='#action.m.id'/>">
                <hr width="97%" align="center" size='0'>
                <div align="center">
