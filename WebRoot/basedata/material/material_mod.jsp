...
<html>
	...
	<body class="body1">
        <form name="itemForm" target="_self" id="itemForm"  method='post' action="basedata/material!modMaterial" >
            <div align="center">
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td width="522" class="p1" height="25" nowrap="nowrap" >
                            ...
                            &nbsp;
                            <b>基础数据管理&gt;&gt;物料维护&gt;&gt;修改</b> <span style='color: red'> <s:iterator value="#action.actionMessages" var='msg'> <s:property value='#msg' /> </s:iterator> </span>
                        </td>
                    </tr>
                </table>   
