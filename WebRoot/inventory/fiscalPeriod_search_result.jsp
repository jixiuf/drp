...
<%@ taglib prefix="s" uri="/struts-tags" %>
            ...
            <table width="95%" border="1" cellspacing="0" cellpadding="0"
                ...
                <tr>
                    ...
                    <td class="rd8">              
                      <a  onclick='window.open("<%=basePath %>basedata/client/client!showDistribDetail?client.id=<s:property value='#c.id'/>","分销商详细信息" ,"width=500, height=400, scrollbars=no" );return false; ' href=''>
